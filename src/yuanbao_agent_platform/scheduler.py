...
from yuanbao_agent_platform.models import ExecutionJob, ExecutionResult, ResultStatus, Scenario, Task, TaskStatus
...
class ExecutionScheduler:
    ...
    def _empty_trace(self, reason: str):
        from yuanbao_agent_platform.models import ExecutionTrace
